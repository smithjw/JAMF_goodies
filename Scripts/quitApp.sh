...
HELPER=`/Library/Application\ Support/JAMF/bin/jamfHelper.app/Contents/MacOS/jamfHelper -windowType utility -icon /Library/Application\ Support/CAmperIT/enso@512.png -title "$4" -heading "Security Vulnerability" -alignHeading center -description "$4 needs to quit in order to be updated immediately. Please save any work that may be in progress." -button1 "Quit" -button2 "Cancel" -defaultButton 1 -cancelButton 2`
